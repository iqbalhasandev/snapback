...
echo "  1. Setup rclone:  ${GREEN}$BACKUP_CMD setup-rclone${NC}"
echo "  2. Edit config:   ${GREEN}$BACKUP_CMD edit${NC}"
echo "  3. Test:          ${GREEN}$BACKUP_CMD test${NC}"
echo "  4. Run backup:    ${GREEN}$BACKUP_CMD backup${NC}"
echo "  5. Setup cron:    ${GREEN}$BACKUP_CMD cron${NC}"
echo ""
